...
def analyze_and_speak(frame):
    ...
    print(f"🧠 [Gemini Strategy Agent] {advice[:80]}")
                        ...
                        for part in sc.model_turn.parts:
                            if getattr(part, "inline_data", None):
                                if isinstance(part.inline_data.data, bytes):
                                    print(f"🔊 [Gemini Live API] Audio reply: {len(part.inline_data.data)} bytes")
...
print("━" * 50)
print("🎯 AuctionEye — AI Flea Market Agent")
print("   Built with Gemini 2.5 Flash + Gemini Live API")
print("   Memory: Google Cloud Firestore")
print("━" * 50)
